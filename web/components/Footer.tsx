                ...
                <div className="grid gap-8 md:grid-cols-4">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-4 flex items-center gap-4">
                            ...
                            >
                                <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 opacity-80 group-hover:opacity-100" fill="currentColor">
                            ...
                            <Link href="/contact" className="group inline-flex items-center gap-2" aria-label="Contact PUM">
                                <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 opacity-80 group-hover:opacity-100" fill="currentColor">
