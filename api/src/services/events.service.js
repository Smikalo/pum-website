...
async function listEvents(query, baseUrl) {
...
async function getEventBySlug(slug, baseUrl) {
...
async function updateEvent(slug, data, user, existingEvent = null) {
...
async function deleteEvent(slug, confirmSlug, user) {
